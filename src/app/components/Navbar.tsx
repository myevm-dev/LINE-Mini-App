      ...
      <div className="mx-auto w-full max-w-6xl px-4 py-3 flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
        ...
        <div className="flex items-center gap-6">
          ...
          <div className="flex items-center gap-4">
            <a href="#" className="text-sm text-neutral-300 hover:text-white">Chat</a>
            <a href="#" className="text-sm text-neutral-300 hover:text-white">Store</a>
            <a href="#" className="text-sm text-neutral-300 hover:text-white">Top Up</a>
          </div>
        </div>
